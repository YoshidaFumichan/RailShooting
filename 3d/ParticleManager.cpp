...
void ParticleManager::Update()
{
	...
	// 頂点バッファへデータ転送
	int vertCount = 0;
	VertexPosColorScale* vertMap = nullptr;
...
void ParticleManager::CreateModel()
{
	...
	result = device->CreateCommittedResource(
		...
		D3D12_HEAP_FLAG_NONE,
		&CD3DX12_RESOURCE_DESC::Buffer(sizeof(VertexPosColorScale) * vertexCount),
		D3D12_RESOURCE_STATE_GENERIC_READ,
		nullptr,
	...
	vbView.SizeInBytes = sizeof(VertexPosColorScale) * vertexCount;
	vbView.StrideInBytes = sizeof(VertexPosColorScale);
}